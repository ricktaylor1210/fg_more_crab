...
from fg_more_crabScripts.client.ui.base_class.location_settings import location_settings
...
class UIManager(object):
    ...
    def __init__(self):
        ...
        self.ui_register_list = [
            "fg_more_crab_location_settings",
        ]
        self.ui_data = {
            # key:{
            #   "ui_name":key,
            ...
            # }
            "fg_more_crab_location_settings": {
                'class_path': UiBasePath + 'base_class.location_settings.location_settings',
            },
        }
    ...
    def location_settings(self):
        """
        :rtype: location_settings
        """
        return self.ui_instance.get('location_settings', None)
